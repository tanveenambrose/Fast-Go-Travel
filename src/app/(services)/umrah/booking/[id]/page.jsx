            ...
            <div className="bg-white border rounded-xl shadow-sm p-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-blue-50 rounded-lg p-4 flex flex-col justify-center items-center text-center">
                  <p className="text-[#989898] text-[22px] font-semibold">
                    Starts from
                  </p>
                  <p className="text-[34px] font-bold">
                    <span className="text-sm font-geist ">BDT</span>{" "}
              ...
              {/* Booking Form */}
              <div className="mt-8">
                <h3 className="text-md font-bold mb-4">Help us to reach you</h3>
                <form className="space-y-4">
                  ...
                  <div className="flex gap-4 justify-end pt-4">
                    ...
                    >
                      <Link href="/umrah" className="flex items-center gap-2">
                        Back
                      </Link>
                    </Button>
                    <button
