...
export default function CtaSection() {
  return (
    <section className="relative bg-blue-600 rounded-xl overflow-hidden  px-6 sm:px-12 md:px-20 text-white flex flex-row items-center justify-between py-28 mt-10 mb-20 max-w-7xl mx-auto">
      {/* Phone images */}
